...
class Rental {
    ...
    days;
    totalCost;
    constructor(rentalId, customer, vehice, days) {
...
class RentalAgency {
    ...
    customer;
    rentals;
    constructor(vehices, customer, rentals) {
    ...
    rentVehice(customerId, vehiceId, days) {
...
mainMenu();
export {};
//# sourceMappingURL=HN-PTIT-CNTT5_HoangTrungDung_07.js.map