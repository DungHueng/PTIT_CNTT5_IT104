...
class Magazine extends libaryItem {
    issueNumber;
            ...
            case 2:
                ...
                switch (itemType) {
                    case "1":
                        ...
                        let newBook = new Book(library.items.length, bookTitle, itemType);
                        library.addItem(newBook);
                        break;
                    case "2":
                        let magazineTitle = String(prompt("Nhập tiêu đề tạp chí: "));
                        let issueNumber = Number(prompt("Nhập số phát hành: "));
                        let newMagazine = new Magazine(library.items.length, magazineTitle, issueNumber);
